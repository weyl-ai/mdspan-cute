...
1. **Commutativity:** $a + b = b + a$, and $a \\times b = b \\times a$.
1. **Distributivity:** $a \\times (b + c) = (a \\times b) + (a \\times c)$.
1. **Identity:** there exist two *different* elements $0$ and $1$ such that $a + 0 = a$ and $a \\times 1 = a$.
1. **Additive inverses:** for every $a$, there exists an element, denoted $-a$, such that $a + (-a) = 0$.
1. **Defition of subtraction:** $a - b \\coloneqq a + (-b)$
1. **Multiplicative inverses:** for every $a \\neq 0$, there exists an element, denoted by $1/a$, such that $a \\times (1/a) = 1$.
1. **Defition of division:** $a / b \\coloneqq a \\times (1/b)$
