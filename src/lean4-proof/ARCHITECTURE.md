...
1. Preconditions become early-return guards
1. The theorem statement becomes a boolean check
1. RapidCheck generates random inputs to test the properties
...
1. Extracts property tests to validate C++ implementation
1. Ensures GPU tiling/scheduling correctness by construction
