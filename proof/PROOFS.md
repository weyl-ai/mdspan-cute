...
nix develop --command buck2 test //tests:
...
# Writes to proof/extracted/cpp/
```

Then copy the generated files to `tests/`.
...
1. Bug in C++ code
2. Bug in property extraction
3. Integer overflow (tests use `size_t`)
